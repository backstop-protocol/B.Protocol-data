...
export class Liquidation__Params {
  ...
  get _VSTGasCompensation(): BigInt {
...
export class Redemption__Params {
  ...
  get _attemptedVSTAmount(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }

  get _actualVSTAmount(): BigInt {
    return this._event.parameters[2].value.toBigInt();
  }
...
export class VSTTokenAddressChanged__Params {
  ...
  get _newVSTTokenAddress(): Address {
    return this._event.parameters[0].value.toAddress();
  }
}
...
export class troveManager extends ethereum.SmartContract {
  ...
  L_VSTDebts(param0: Address): BigInt {
    let result = super.call("L_VSTDebts", "L_VSTDebts(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_L_VSTDebts(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("L_VSTDebts", "L_VSTDebts(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  checkRecoveryMode(_asset: Address, _price: BigInt): boolean {
    let result = super.call(
      "checkRecoveryMode",
  ...
  getBorrowingFee(_asset: Address, _VSTDebt: BigInt): BigInt {
    let result = super.call(
      "getBorrowingFee",
      "getBorrowingFee(address,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(_asset),
        ethereum.Value.fromUnsignedBigInt(_VSTDebt)
      ]
    );
  ...
  getBorrowingFeeWithDecay(_asset: Address, _VSTDebt: BigInt): BigInt {
    let result = super.call(
  ...
  getPendingVSTDebtReward(_asset: Address, _borrower: Address): BigInt {
    let result = super.call(
      "getPendingVSTDebtReward",
      "getPendingVSTDebtReward(address,address):(uint256)",
      [
        ethereum.Value.fromAddress(_asset),
        ethereum.Value.fromAddress(_borrower)
      ]
  ...
  lastVSTDebtError_Redistribution(param0: Address): BigInt {
    let result = super.call(
      "lastVSTDebtError_Redistribution",
      "lastVSTDebtError_Redistribution(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
  ...
  try_lastVSTDebtError_Redistribution(
    param0: Address
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lastVSTDebtError_Redistribution",
